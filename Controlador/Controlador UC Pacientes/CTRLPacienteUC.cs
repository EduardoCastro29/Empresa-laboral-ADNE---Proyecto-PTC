        ...
        private void CargarInformacionPersonal(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Comprobar)
                {
                    ...
                    ObjVerInformacion.txtEdad1.Text = ObjDaoInformacionPersonal.Edad.ToString();
        ...
        private void ActualizarInformacionPaciente(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    ObjDAOActualizarInformacionPersonal.Edad = int.Parse(ObjInformacionPersonal.txtEdad1.Text.Trim());
